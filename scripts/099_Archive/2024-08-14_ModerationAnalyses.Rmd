...
# Define as.numeric()
data_bias_h1 <- data_bias_h1 %>%
  dplyr::mutate(across(contains("bias"), as.numeric))

# Histogram OCD vs. Neutral
ggplot(data_bias_h1, aes(x = bias_ocdvsneutral)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)

# Histogram OCD vs. Negative
ggplot(data_bias_h1, aes(x = bias_ocdvsnegative)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)

# Histogram OCD vs. Healthy
ggplot(data_bias_h1, aes(x = bias_ocdhealthy)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
...
# Histogram OCD vs. Spider
ggplot(data_bias_h1, aes(x = bias_ocdspider)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
...
# Histogram OCD vs. Neutral
ggplot(data_bias_h2a, aes(x = bias_ocdvsneutral)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
...
# Histogram OCD vs. Negative
ggplot(data_bias_h2a, aes(x = bias_ocdvsnegative)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)

# Histogram Healthy OCD vs. Neutral
ggplot(data_bias_h2a, aes(x = bias_healthy_ocdvsneutral)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
...
# Histogram Healthy OCD vs. Negative
ggplot(data_bias_h2a, aes(x = bias_healthy_ocdvsnegative)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)

# Histogram Healthy Spider vs. Negative
ggplot(data_bias_h2a, aes(x = bias_healthy_spidervsneutral)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
...
# Histogram Healthy Spider vs. Negative
ggplot(data_bias_h2a, aes(x = bias_healthy_spidervsnegative)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
...
# Histogram OCD vs. Neutral
ggplot(data_bias_h2b, aes(x = bias_ocdvsneutral)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
...
# Histogram OCD vs. Negative
ggplot(data_bias_h2b, aes(x = bias_ocdvsnegative)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
...
# Histogram Healthy OCD vs. Neutral
ggplot(data_bias_h2b, aes(x = bias_healthy_ocdvsneutral)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
...
# Histogram Healthy OCD vs. Negative
ggplot(data_bias_h2b, aes(x = bias_healthy_ocdvsnegative)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
...
# Histogram Healthy Spider vs. Negative
ggplot(data_bias_h2b, aes(x = bias_healthy_spidervsneutral)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
...
# Histogram Healthy Spider vs. Negative
ggplot(data_bias_h2b, aes(x = bias_healthy_spidervsnegative)) +
  geom_histogram() +
  labs(x = "OCD vs Neutral Bias", y = "Count", title = "Histogram by Group") +
  theme_minimal() + 
  facet_grid(. ~ group)
