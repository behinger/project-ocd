...
# Define the model comparisons to test the specific hypothesis of hypothesis 2
g = (glht(h2b_fm_excl_triplet_item, (c("groupocd:looked_atocd - groupocd = 0", # Patients with OCD fixate faster on idiosyncratic OCD-relevant material as compared to neutral material (entry time bias within group)
                            "groupocd:looked_atocd - groupocd:looked_atneg = 0", # Patients with OCD fixate faster on OCD-relevant material as compared to negative material (entry time bias within group)
